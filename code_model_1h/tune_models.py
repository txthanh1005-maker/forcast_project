...
def main():
    ...
    print_info("Tuning LightGBM for t+1...")
    # Use optuna to tune
    ...
    joblib.dump(best_lgbm, os.path.join(models_dir, "tuned_lgbm_model.pkl"))
    
    print_info("Tuning XGBoost for t+1...")
    ...
    joblib.dump(best_xgb, os.path.join(models_dir, "tuned_xgb_model.pkl"))
