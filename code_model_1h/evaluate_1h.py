...
def main():
    ...
    print_info("Loading tuned models...")
    lgbm_model = joblib.load(os.path.join(models_dir, "tuned_lgbm_model.pkl"))
    xgb_model = joblib.load(os.path.join(models_dir, "tuned_xgb_model.pkl"))
    
    print_info("Predicting with tuned models...")
    ...
    plot_window(0, min(168, len(true_vals)), 'Model Predictions vs Actual (7-Day Window) - 1h Tuned', '1h_tune_7days.png', figures_dir, true_vals, lgbm_preds, xgb_preds)
